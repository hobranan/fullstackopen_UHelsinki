      ...
      <div>
        <table>
          <tbody>
            ...
            <StatisticLine
              text="all"
              value={calcAll(props.good, props.neutral, props.bad)}
            />
            <StatisticLine
              text="average"
              value={calcAverage(props.good, props.neutral, props.bad)}
            />
            <StatisticLine
              text="positive"
              value={calcPositive(props.good, props.neutral, props.bad) + " %"}
            />
          </tbody>
        </table>
      </div>
